...
const swaggerOptions = {
  definition: {
    ...
    servers: [
      {
        url: process.env.BASE_URL || 'https://delish-backend.onrender.com', // ✅ CHANGE this to your Render backend URL
      },
    ],
  },
  apis: ['./src/routers/*.js'],
...
// Optional Fallback for SPA (only if frontend is also hosted here)
// app.get('*', (req, res) => {
//   const indexFilePath = path.join(publicFolder, 'index.html');
//   res.sendFile(indexFilePath);
// });
